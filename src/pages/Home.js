          ...
          <div className="row">
            <div className="col-lg-6 text-center text-lg-left mb-2 mb-lg-0">
              <div className="d-inline-flex align-items-center">
                <p>
                  <i className="fa fa-envelope mr-2"></i>madhavpur5@gmail.com
                </p>
              ...
              <div className="package-item bg-white mb-2">
                ...
                <div className="p-4">
                  <div className="d-flex justify-content-between mb-3">
                    ...
                    <small className="m-0">
                      <i className="fa fa-calendar-alt text-primary mr-2"></i>3
                      days
                    </small>
                    <small className="m-0">
      ...
      >
        <div className="row pt-5">
          <div className="col-lg-3 col-md-6 mb-5">
            <a href="#" className="navbar-brand">
              <h1 className="text-primary">
                <span className="text-white">MADHAV</span>PUR
              </h1>
            </a>
            <p>Welcome to Madhavpur</p>
            <h6
          ...
          <div className="col-lg-3 col-md-6 mb-5">
            ...
            <p>
              <i className="fa fa-map-marker-alt mr-2"></i>Madhavpur Ghed,
              Porbandar, Gujarat, IN
            </p>
            <p>
              <i className="fa fa-envelope mr-2"></i>madhavpur5@gmail.com
            </p>
